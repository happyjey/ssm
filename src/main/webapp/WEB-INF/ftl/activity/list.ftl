...
<div>
	...
	<div class="page-container">
		<div class="text-c"> 日期范围：
			<input type="text" name="act_stime" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'logmax\')||\'%y-%M-%d\'}' })" id="logmin" class="input-text Wdate" style="width:120px;">
			-
			<input type="text" name="act_stime" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'logmin\')}',maxDate:'%y-%M-%d' })" id="logmax" class="input-text Wdate" style="width:120px;">
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				<thead>
					<tr class="text-c">
						<th width="40"><input name="act_id" type="checkbox" value=""></th>
						<th width="40">ID</th>
						<th width="40">UID</th>
						<th width="60">缩略图</th>
						<th>活动简介</th>
				...
				<tbody>
					<#list pageInfo.list as v>
						<tr class="text-c va-m">
							<td><input name="act_id" type="checkbox" value="${v.actId}"></td>
							<td>${v.actId}</td>
							<td>${v.actUid}</td>
							<td class="text-l"><img src="${v.actPic}"></td>
							<td class="text-l">${v.actDesc}</td>
							<td class="text-l">${v.actAddress}</td>
							<td class="text-l">${v.actStime?datetime}</td>
							<td><span class="price">${v.actFee}</span> 元</td>
							<td class="td-status"><span class="label label-success radius">已发布</span></td>
							<td>${v.actAtime?datetime}</td>
			...
			<div class="dataTables_wrapper ">
				<div class="dataTables_info">显示 1 到 1 ，共 1 条</div>
				<div class="dataTables_paginate paging_simple_numbers">
					<a class="paginate_button previous disabled">上一页</a>
					<span><a class="paginate_button current">1</a></span>
